"""
Django settings for backend_tax_calculator project.
...
SECRET_KEY = 'django-insecure-zxt-t3%)uo=69r1zs2t%uw$^p+ba8g8^x3o(frc2wwh1m(_285'
...
ROOT_URLCONF = 'backend_tax_calculator.urls'
